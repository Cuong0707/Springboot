...
public class KhuyenMaiDAO extends DAO<KhuyenMai, String> {
    ...
    String SELECT_BY_DATES_SQL = "Select * From KhuyenMai Where NgayBatDau <= DATE(NOW()) and NgayKetThuc >= DATE(NOW());";
...
//            rs.getStatement().getConnection().close();
    ...
    public List<KhuyenMai> selectByToDay() {
        return this.selectBySql(SELECT_BY_DATES_SQL);
    }
}
